      ...
      <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-8 backdrop-blur-sm">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-400">We offer various ticket tiers ranging from ₹800 to ₹5000 (Gold, Platinum, VIP, and Special VIP). Each tier includes different benefits and access levels. Visit our Pricing section for detailed information.</p>
          </div>
